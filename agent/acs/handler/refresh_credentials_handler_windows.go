...
func setDomainlessGMSATaskExecutionRoleCredentials(iamRoleCredentials credentials.IAMRoleCredentials, taskArn string) error {
	return credentialspec.SetTaskExecutionCredentialsRegKeys(iamRoleCredentials, taskArn)
}
